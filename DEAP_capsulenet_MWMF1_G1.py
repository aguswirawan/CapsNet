...
def data_load(data_file,dimention,debaseline):
    ...
    dataset_dir = "amigos_shuffled/deap_shuffled_noise_MWMF_1_div/" + with_or_without + "_" + arousal_or_valence + "/"
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_noise_MWMF_1_div/sub_dependent_'+ model_version +'/') # other
