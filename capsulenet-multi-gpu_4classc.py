...
def CapsNet(input_shape, n_class, routings, batch_size):
    ...
    primarycaps = PrimaryCap(conv4, dim_capsule=8, n_channels=32, kernel_size=4, strides=1, padding='same')
    ...
    for dimention in dimentions:
        for subject in subjects:
            ...
            for curr_fold in range(fold):
                ...
                y_pred = eval_model.predict(x_test, batch_size=2)  # batch_size = 100
