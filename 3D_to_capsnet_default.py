...
if __name__ == '__main__':
    ...
    label = 'all'
    if use_baseline=='yes':
        dataset_dir = '3D_dataset_MWMF_fractional/with_base/'
    else:
        dataset_dir = '3D_dataset_MWMF_fractional/without_base/'

    result_dir = f'deap_shuffled_MWMF_fractional/{use_baseline}_{label}/'
