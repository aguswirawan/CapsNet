...
def CapsNet(input_shape, n_class, routings, batch_size):
    ...
    conv3 = layers.Conv2D(filters=256, kernel_size=4, strides=1, padding='same', activation='relu', name='conv3')(conv2)
     conv4 = layers.Conv2D(filters=512, kernel_size=4, strides=1, padding='same', activation='relu', name='conv4')(conv3)
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_hyper4/Group/sub_dependent_'+ model_version +'/') # other
