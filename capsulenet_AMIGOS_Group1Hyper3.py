...
subjects = ['Data_Preprocessed_P20','Data_Preprocessed_P25','Data_Preprocessed_P26','Data_Preprocessed_P27','Data_Preprocessed_P29','Data_Preprocessed_P30','Data_Preprocessed_P31','Data_Preprocessed_P34','Data_Preprocessed_P35','Data_Preprocessed_P36','Data_Preprocessed_P37','Data_Preprocessed_P38','Data_Preprocessed_P39','Data_Preprocessed_P40']
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_amigos_hyper3/Group/sub_dependent_'+ model_version +'/') # other
