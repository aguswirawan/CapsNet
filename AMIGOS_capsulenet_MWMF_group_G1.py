...
def data_load(data_file,dimention,debaseline):
    ...
    dataset_dir = "amigos_shuffled/amigos_shuffled_MWMF_div/Group/" + with_or_without + "_" + arousal_or_valence + "/"
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_MWMF_div/Group/sub_dependent_'+ model_version +'/') # other
