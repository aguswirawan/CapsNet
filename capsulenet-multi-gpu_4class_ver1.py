...
def CapsNet(input_shape, n_class, routings, batch_size):
    ...
    conv1 = layers.Conv2D(filters=64, kernel_size=4, strides=1, padding='same', activation='selu', name='conv1', kernel_regularizer=regularizers.l2(0.5))(x)
    # print(conv1.shape)
    ...
    # conv6 = layers.Conv2D(filters=256, kernel_size=1, strides=1, padding='same', activation='selu', name='conv6')(conv4)
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_MWMF_fractional/sub_dependent_'+ model_version +'/') # other
