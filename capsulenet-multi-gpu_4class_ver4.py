...
def data_load(data_file,dimention,debaseline):
    ...
    dataset_dir = "/content/drive/MyDrive/Data Doktor/Bahan Desertasi/Data & Alat/DEAP/Data_Uji_CapsNet/deap_shuffled_MWMF_div/" + with_or_without + "_" + arousal_or_valence + "/"
...
subjects = ['s02'] #'s01','s02','s03','s04','s05','s06','s07','s08','s09','s10','s11','s12','s13','s14','s15','s16','s17','s18','s19','s20',
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--epochs', default=20, type=int)  # v0:20, v2:40
            ...
            parser.add_argument('--save_dir', default='/content/drive/MyDrive/Data Doktor/Bahan Desertasi/Data & Alat/DEAP/Data_Uji_CapsNet/result_MWMF_div/sub_dependent_'+ model_version +'/')
