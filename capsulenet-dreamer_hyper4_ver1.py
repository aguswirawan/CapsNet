...
def data_load(data_file,dimention,debaseline):
    ...
    dataset_dir = "amigos_shuffled/dreamer_shuffled_dataset/" + with_or_without + "_" + arousal_or_valence + "/"
...
subjects = ['res01','res02','res03','res04','res05','res06','res07','res08','res09','res10','res11','res12'] #'s01','s02','s03','s04','s05','s06','s07','s08','s09','s10','s11','s12','s13','s14','s15','s16','s17','s18','s19','s20',
